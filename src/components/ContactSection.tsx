  ...
  const supportChannels = [
    {
      ...
      handle: '@lastgamingbd_official',
      url: 'https://t.me/lastgamingbd',
    ...
    },
    {
      ...
      handle: 'support@lastgamingbd.com',
      url: 'mailto:support@lastgamingbd.com',
      icon: Mail,
      isImage: false,
      color: 'border-[#B2D959]/60 text-[#0F172A]',
    ...
    },
    {
      ...
      handle: 'Last Gaming BD Official',
